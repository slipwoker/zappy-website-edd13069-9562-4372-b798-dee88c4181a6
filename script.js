document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateField(field) {
        ...
        if (field.hasAttribute('required') && value === '') {
            ...
            } else if (name && name.toLowerCase().includes('name') && value.length < 2) {
                isValid = false;
            ...
            if (isValid) {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        const allSuccessFields = contactForm.querySelectorAll('.success');
                        allSuccessFields.forEach(f => f.classList.remove('success'));
                    } else {
    ...
    function handleScrollAnimations() {
        ...
        animatedElements.forEach(element => {
            ...
            const triggerPoint = scrollY + windowHeight * 0.85;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'edd13069-9562-4372-b798-dee88c4181a6',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'edd13069-9562-4372-b798-dee88c4181a6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'edd13069-9562-4372-b798-dee88c4181a6';
